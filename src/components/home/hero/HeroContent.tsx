...
export default function HeroContent() {
  ...
  return (
    <div className="space-y-12">
      ...
      >
        <span className="text-accent block mb-2">CBE Capital: Pioneering Ethiopia's</span>
        <span className="block">&amp; Africa's Financial Future</span>
      </motion.h1>
      ...
      >
        Driving financial inclusion and empowerment across Ethiopia and the African continent.
      </motion.p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {features.map((feature, index) => (
          <motion.div
            ...
            className="relative h-40 md:h-48 rounded-lg overflow-hidden group"
          >
            <img
              src={feature.image}
              alt={feature.title}
            ...
            <div className="absolute inset-0 p-4 flex flex-col justify-end">
              ...
              <p className="text-accent-light text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                {feature.description}
              </p>
            </div>
          </motion.div>
